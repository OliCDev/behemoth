...
<div
	class="align-center relative flex h-screen overflow-y-scroll w-full flex-col overflow-hidden bg-linear-[80deg] from-mist-100 from-45% to-mist-200 bg-fixed lg:from-40% dark:from-mist-900 dark:to-gray-900"
>
	{#if user}
		<Navbar {user} />
	{/if}
